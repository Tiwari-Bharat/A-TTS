  ...
  return (
    <div>
      ...
      <div className="relative">
        <select
          id={props.id || "select"}
          className={`w-full p-3 bg-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-xl text-slate-200 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all appearance-none shadow-inner ${props.disabled ? "opacity-50 cursor-not-allowed" : "hover:border-slate-600"}`}
          style={{
